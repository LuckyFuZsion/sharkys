    ...
    >
      ...
      >
        <a
          ...
          className="bg-blue-600 text-white p-3 rounded-full shadow-lg hover:bg-blue-700 hover:scale-110 transition-all"
          aria-label="Call us"
        >
        ...
        <a
          ...
          className="bg-green-500 text-white p-3 rounded-full shadow-lg hover:bg-green-600 hover:scale-110 transition-all"
        ...
        <a
          ...
          className="bg-blue-500 text-white p-3 rounded-full shadow-lg hover:bg-blue-600 hover:scale-110 transition-all"
          aria-label="Email us"
        >
